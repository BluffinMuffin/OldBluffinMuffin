...
{
    public class GameTcpServer1 : CommandQueueCommunicator<GameObserver>
    {
        #region Fields
        ...
        #region Ctors & Init
        public GameTcpServer1(int id, PokerGame game, string name)
        {
            m_Id = id;
            m_Game = game;
        ...
        public GameTcpServer1(int id, PokerGame game, UserInfo userInfo)
        {
            m_Id = id;
            m_Game = game;
            m_UserInfo = userInfo;

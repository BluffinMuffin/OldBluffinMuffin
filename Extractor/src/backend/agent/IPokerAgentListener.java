...
public interface IPokerAgentListener extends IPokerAgent
{
    ...
    // public static final Method TAKE_ACTION = Util.getIPokerAgentListenerMethod("takeAction", ArrayList.class, int.class, int.class, int.class);
     ...
     *            contains all indices of the board cards that have been modified.
     */
    ...
    // * @param p_actionsAllowed contains the list of actions allowed.
    // * @param p_callAmount is the amount for calling.
    // * @param p_minRaiseAmount is the minimum raise allowed.
    // * @param p_maxRaiseAmount is the maximum raise allowed.
    // */

 ...
 */
public class OldServerTableManager extends Thread implements IClosingListener<ServerTableCommunicator>
{
    ...
    public OldServerTableManager(ServerTableCommunicator p_table, int p_noPort) throws IOException
    {
        m_table = p_table;
    ...
    public void run()
    {
        ...
        while ((m_socketServer != null) && m_table.isRunning())
        {
            try
            {
                ...
                final OldServerClientTableManager client = new OldServerClientTableManager(socketClient,this);
                client.start();
            }

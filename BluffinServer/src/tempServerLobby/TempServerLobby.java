 ...
 */
public class TempServerLobby extends Thread
{
    ...
    public static void main(String args[])
    {
        try
        {
            final TempServerLobby server = new TempServerLobby(Constants.DEFAULT_NO_PORT);
            server.start();
    ...
    public void run()
    {
        while (true)
        {
            try
            {
                ...
                final TempServerClientLobby client = new TempServerClientLobby(socketClient, this);
                client.start();
            }
            catch (final IOException e)
            {

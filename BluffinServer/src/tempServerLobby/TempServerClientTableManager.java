 ...
 */
public class TempServerClientTableManager extends Thread
{
    String m_name = "?";
    TempServerTableManager m_manager;
    ...
    public TempServerClientTableManager(Socket p_socket, TempServerTableManager p_manager)
    {
        m_socket = p_socket;
        m_manager = p_manager;
        try
        ...
        m_commandObserver.subscribe(new LobbyServerSideAdapter()
        {
            ...
            public void joinTableCommandReceived(LobbyJoinTableCommand command)
            {
                try
                {
                    ...
                    final TcpPokerClient client = new TcpPokerClient(m_manager.m_game, m_name, Constants.STARTING_MONEY, m_socket);

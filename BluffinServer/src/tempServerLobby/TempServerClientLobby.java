 ...
 */
public class TempServerClientLobby extends Thread
{
    private String m_playerName = "?";
    private final TempServerLobby m_lobby;
    ...
    public TempServerClientLobby(Socket socket, TempServerLobby lobby)
    {
        m_socket = socket;
        m_lobby = lobby;
        try

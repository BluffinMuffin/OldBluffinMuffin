...
public class TempServerPokerTableInfo extends OldPokerTableInfo
{
    // Players variables
    ...
    public TempServerPokerTableInfo()
    {
        this(9);
    }
    
    public TempServerPokerTableInfo(int nbSeats)
    {
        this("Anonymous", TypePokerGame.NO_LIMIT, 5, nbSeats);
    }
    
    public TempServerPokerTableInfo(String pName, TypePokerGame pGameType, int pBigBlind, int nbSeats)
    {
    ...
    public TempServerPokerTableInfo(LobbyCreateTableCommand command)
    {
     ...
     */
    public int getMinimumRaise(TempServerPokerPlayerInfo p_player)
    {
     ...
     */
    public int getMaximumRaise(TempServerPokerPlayerInfo p_player)
    {
    ...
    public GameTableInfoCommand buildCommand(TempServerPokerPlayerInfo pPlayer)
    {
        ...
        for (int i = 0; i != getNbPlayers(); ++i)
        {
            ...
            final TempServerPokerPlayerInfo player = (TempServerPokerPlayerInfo) getPlayer(i);

 ...
 */
public abstract class TempServerPokerPlayerInfo extends OldPokerPlayerInfo
{
    protected boolean m_isFolded;
    protected boolean m_cardShowed;
    protected boolean m_sitOutNextHand;
    protected TempServerTableCommunicator m_table;
    
    /**
     * Create a new player named "Anonymous Player" with no money
     */
    public TempServerPokerPlayerInfo()
    {
     ...
     */
    public TempServerPokerPlayerInfo(String p_name)
    {
        this(p_name, 0);
    }
     ...
     */
    public TempServerPokerPlayerInfo(String p_name, int p_money)
    {
        super(p_name, p_money);
        m_isFolded = false;
    }
    
    public TempServerTableCommunicator getTable()
    {
        return m_table;
    }
    ...
    public void setTable(TempServerTableCommunicator p_table)
    {
        m_table = p_table;
    }
